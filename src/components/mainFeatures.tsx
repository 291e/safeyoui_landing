...
export function MainFeatures() {
  ...
  return (
    ...
    >
      <div className="p-4 sm:px-8 md:px-16 xl:px-32 rounded-t-2xl bg-gray-900">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-8">
          <div className="mt-18 mb-4 text-blue-500 font-bold text-sm">
            Main Features
          </div>
          ...
          <p className="text-sm opacity-50 max-w-[250px] lg:max-w-none text-center lg:text-left">
            실시간 소통으로 사고를 예방하고, 현장의 안전을 한눈에 확인하세요.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="relative">
                ...
                <Card className="bg-white text-gray-900 hover:shadow-lg transition-shadow pt-8 my-2">
                  ...
                  <CardContent className="w-full flex justify-center px-2">
                    <CardDescription className="text-base text-center text-black">
                      {feature.description}
                    </CardDescription>
                  </CardContent>
                </Card>
